            ...
            <div className="bg-[#fefaf9] p-6 rounded-lg shadow-sm">
              ...
              {form.paymentMethod === 'Advance payment' && (
                <div className="mt-6 p-4 border border-blue-300 bg-blue-50 rounded-md">
                  <h3 className="text-base sm:text-lg font-semibold mb-3">Advance payment Payment Details</h3>
                  <p className="text-gray-700 mb-4 text-sm sm:text-base">
                    Please send the total amount of PKR {total.toLocaleString()} to our Allied Bank account:
                  </p>
                  <ul className="list-disc list-inside text-gray-800 mb-4 text-sm sm:text-base">
                    <li><strong>Account Name:</strong> Daniya amir and syed khizer </li>
                    <li><strong>IBAN</strong>PK21ABPA0010042756300012</li>
                  </ul>
                  <p className="text-gray-700 mb-4 text-sm sm:text-base">
                  ...
                  <div>
                    <label htmlFor="bankTransferProof" className="block text-sm font-medium text-gray-700 mb-1">
                      Upload Advance payment Transaction Screenshot*
                    </label>
                    <input
